...
export default {
  ...
  "components/HeroSection.vue": () => import('./_nuxt/HeroSection-styles.5XEqW3G_.mjs').then(interopDefault),
  "components/HeroSection.vue?vue&type=style&index=0&scoped=349c1e96&lang.css": () => import('./_nuxt/HeroSection-styles.CcxhRkaN.mjs').then(interopDefault)
}